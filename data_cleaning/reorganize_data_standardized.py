...
for language in data:
    for feat in features_to_remove:
        data[language].pop(feat, None)

#normalizing

features = ('1A', '2A', '3A', '4A', '6A', '7A', '8A', '9A', '10A', '11A', '13A','19A','20A', '21A', '21B', '22A', '23A', '24A', '25A','25B', '26A','27A', '28A', '29A')
feature_values = {}
for language in data:
